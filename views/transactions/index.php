...
<div class="d-flex justify-content-between align-items-center mb-3">
    ...
    <a href="/transactions/create" class="btn btn-success"><i class="fas fa-cash-register"></i> Transaksi Baru</a>
</div>
                ...
                <tr>
                    ...
                    <td>
                        <span class="badge bg-secondary">
                            <?= htmlspecialchars($transaction['brand'] . ' ' . $transaction['vehicle_model']); ?>
                        </span>
                    </td>
